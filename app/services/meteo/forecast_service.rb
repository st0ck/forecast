module Meteo
  # Handles the process of fetching forecast.
  class ForecastService
    H3_RESOLUTION = 8
    CACHE_EXPIRATION = 6.hours
    CACHE_PREFIX = 'forecast'.freeze
    ...
    def initialize(lat, lon, redis_pool)
      ...
      @data_fetcher = DataFetcher.new(
        ...
        data_representer: Meteo::Forecast
      )
    end
    ...
    def build_service
      @service ||= begin
        ...
        Integrations::Meteo::Openweather::Forecast.new(lat, lon, request_handler)
      end
    end
  end
end
